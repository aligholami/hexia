...
class VQA(data.Dataset):
    """
    Class to handle big dataset of MS Coco, Open-ended VQA Task.
    """
    ...
    def max_question_length(self):
        """
        Grab maximum question length.
        :return: Maxmimum length of question.
        """
    ...
    def _create_coco_id_to_index(self):
        ...
        """
        Create a mapping from a COCO image id into the corresponding index in h5 file.
        :return: A dictionary of id -> index mappings.
        """
    ...
    def _check_integrity(self, questions, answers):
        """
        Verify data.
        :param questions: questions dict.
        :param answers: answers dict.
        :return:
        """
    ...
    def _find_answerable(self):
        ...
        :return: A list of answerable questions.
        """
        answerable = []
    ...
    def _encode_question(self, question):
        """
        Convert each question to an index list and its length
        :param question: Question string.
        :return: Encoded question and its length.
        """
    ...
    def _encode_answers(self, answers):
        """
        Convert an answer into a vector.
        :param answers: Answers list.
        :return: Vector of answers repeats.
        """
    ...
    def _load_image(self, image_id):
        """
        Load an image from given image id.
        :param image_id: Image ID!
        :return: A numpy-wrapped image.
        """
...
def prepare_questions(questions_json):
    ...
    :param questions_json: Question JSON File.
    :return:
    """
...
def prepare_answers(answers_json):
    ...
    :param answers_json: Answers JSON File.
    :return:
    """
